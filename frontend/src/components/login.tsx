...
const Login = () => {
  ...
  const { user, isLoggedIn, isLoading, login, signUp } = useAuth();
  ...
  // If session is still being verified, show nothing (ProtectedRoute handles its own loader)
  useEffect(() => {
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <button
            type="submit"
            className="mt-4 w-full h-11 rounded-full text-white bg-pink-600 hover:bg-pink-500 transition font-medium"
          >
            {state === "login" ? "Login" : "Sign up"}
          </button>
